...
for i in {1,2,4,5,6}; do zcat ${input_directory}Res2_Phage_${ind}${i}_paired_decontaminated.fastq.1.gz >> ${SLURM_TMPDIR}/Res2_Phage_${ind}_paired_decontaminated.1.fastq; done
for i in {1,2,4,5,6}; do zcat ${input_directory}Res2_Phage_${ind}${i}_paired_decontaminated.fastq.2.gz >> ${SLURM_TMPDIR}/Res2_Phage_${ind}_paired_decontaminated.2.fastq; done
